...
public class MainController {
    ...
    public void switchToAgregarTiempo(ActionEvent event) throws IOException { // REGISTRO
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/parqueoscallejeros/User/UserMainFunctions/ActualizarTiempo.fxml"));
        Parent root = loader.load();

        // Obtén el controlador del nuevo FXML
        ActualizarTiempo controller = loader.getController();
